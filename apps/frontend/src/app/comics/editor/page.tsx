...
function NewComicEditorContent() {
	...
	const handlePromptSubmit = async (prompt: string, imageFiles?: File[], imageBase64s?: string[], imageMimeTypes?: string[]) => {
		...
		try {
			...
			const imageResponse = await generateImageAPI(fullPrompt, characterContext, imageBase64s, imageMimeTypes);
