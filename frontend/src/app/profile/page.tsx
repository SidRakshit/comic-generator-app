...
import { 
  User, Edit, Save, Image, BookOpen, Heart, 
...
// Mock comics data
const userCreatedComics = [
  {
    id: 'comic-1',
    title: 'Space Explorer Chronicles',
    coverImage: '/api/placeholder/300/400?text=Space+Explorer',
  ...
  },
  {
    ...
    coverImage: '/api/placeholder/300/400?text=Last+Dragon',
  ...
  },
  {
    ...
    coverImage: '/api/placeholder/300/400?text=Cybernetic+Dreams',
                ...
                {isEditingProfile ? (
                  <>
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        setIsEditingProfile(false);
                        setProfileData(userData); // Reset changes
                      }}
                    >
                      Cancel
                    </Button>
            ...
            <div className="mt-6 md:mt-0 flex flex-col items-center md:items-end space-y-2">
              <div className="grid grid-cols-2 gap-4 text-center">
                <div className="bg-gray-50 px-4 py-2 rounded-lg">
                  <div className="text-2xl font-bold text-gray-900">{profileData.stats.created}</div>
                  <div className="text-sm text-gray-500">Comics</div>
                </div>
                <div className="bg-gray-50 px-4 py-2 rounded-lg">
                  <div className="text-2xl font-bold text-gray-900">{profileData.stats.favorites}</div>
          ...
          <TabsContent value="comics" className="space-y-6">
            ...
            {userCreatedComics.length > 0 ? (
                ...
                {userCreatedComics.map(comic => (
                  <Link href={`/comics/${comic.id}`} key={comic.id}>
                    <div className="bg-white border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <div className="p-4">
                        <h3 className="font-medium text-lg text-gray-900 mb-1">{comic.title}</h3>
                        <div className="flex justify-between text-sm text-gray-500">
                          <span>Created: {comic.createdAt}</span>
              ...
              <div className="text-center py-12 bg-white rounded-lg border">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No comics yet</h3>
                <p className="text-gray-600 mb-4">Start creating your first comic!</p>
                <Button asChild>
          ...
          <TabsContent value="favorites" className="space-y-6">
            ...
            {userFavoriteComics.length > 0 ? (
              ...
              <div className="text-center py-12 bg-white rounded-lg border">
                ...
                <p className="text-gray-600 mb-4">Browse comics and add some to your favorites!</p>
                <Button asChild>
                  <Link href="/comics">
                    Browse Comics
                  </Link>
          ...
          <TabsContent value="settings" className="space-y-6">
            ...
            <div className="bg-white shadow overflow-hidden rounded-lg">
              ...
              <div className="px-4 py-5 sm:p-6 space-y-6">
                ...
                <div>
                  <h4 className="text-md font-medium text-gray-900 mb-2">Account Preferences</h4>
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        ...
                        <p className="text-gray-500">Receive emails about new comments and likes on your comics.</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="flex items-center h-5">
                      ...
                      <div className="ml-3 text-sm">
                        ...
                        <p className="text-gray-500">Allow other users to view your profile and comics.</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-4 bg-white shadow overflow-hidden rounded-lg">
              ...
              <div className="px-4 py-5 sm:p-6">
                <Link 
                  ...
                  className="text-blue-600 flex items-center justify-between hover:text-blue-800 p-3 border rounded-md hover:bg-gray-50"
                >
