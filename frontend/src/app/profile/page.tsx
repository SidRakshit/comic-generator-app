        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row items-center md:items-start">
            <div className="relative mb-4 md:mb-0 md:mr-6">
              {/* Replaced img with Image, added alt */}
              <Image 
                src={profileData.avatarUrl} 
                alt={`${profileData.name}'s avatar`} // Added descriptive alt text
                width={128} // Corresponds to w-32, h-32
                height={128}
            ...
            {/* ... (Editing/Display logic remains the same) ... */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        <Tabs defaultValue="comics">
          ...
          <TabsContent value="comics" className="space-y-6">
            {/* ... (Header for My Comics remains the same) ... */}
                    ...
                    <div className="bg-white border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <div className="aspect-[3/4] bg-gray-100 relative">
                        ...
                        <Image
                          ...
                          sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" // Optimize loading
                        />
                      </div>
