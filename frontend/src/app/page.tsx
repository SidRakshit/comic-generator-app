...
export default function HomePage() {
  ...
  // If mockFetchFeaturedComics were defined outside or depended on props/state, 
  // it would need to be included here or memoized itself.
  }, []); 

  useEffect(() => {
    // Fetch featured comics
    fetchFeaturedComics();
  // Add fetchFeaturedComics to dependency array
  }, [fetchFeaturedComics]); 
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          {/* ... (Featured Comics header remains the same) ... */}
                  ...
                  <div className="bg-white border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="aspect-[3/4] bg-gray-100 relative">
                      ...
                      <Image
                        ...
                        sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 25vw" // Optimize loading
                      />
                    </div>
