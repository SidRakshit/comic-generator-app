...
if (!DB_CONFIG.user || !DB_CONFIG.host || !DB_CONFIG.database || !DB_CONFIG.password) {
    console.warn("Warning: One or more database configuration variables (DB_USER, DB_HOST, DB_NAME, DB_PASSWORD) are missing.");
}
